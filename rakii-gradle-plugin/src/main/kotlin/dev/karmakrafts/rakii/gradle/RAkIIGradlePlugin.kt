...
/**
 * Gradle plugin for integrating the RAkII compiler plugin with Kotlin projects.
 *
 * This plugin implements the [KotlinCompilerPluginSupportPlugin] interface to register
 * the RAkII compiler plugin with the Kotlin compiler during project builds. It handles
...
open class RAkIIGradlePlugin @Inject constructor(
    ...
    override fun apply(target: Project) {
        target.logger.info("RAkII Compiler Plugin ${BuildInfo.version}")
