...
/**
 * IR visitor that implements the body of drop functions for classes implementing the Drop interface.
 *
 * This visitor is part of the RAkII compiler plugin's IR (Intermediate Representation) phase.
 * It identifies functions that were generated by the RAkIIDropGenerationExtension in the FIR phase
 * and implements their bodies by generating code to call drop() on all DropDelegate properties
...
internal class RAkIIDropLoweringVisitor(
    ...
    /**
     * Finds all properties in a class that are droppable (have a DropDelegate backing field).
     *
     * @param declaration The class to search for droppable properties
     * @return A list of droppable properties
     */
    ...
    /**
     * Creates an IR call to the drop method on a DropDelegate field.
     *
     * This method generates the IR code to call drop() on a DropDelegate property's backing field.
     *
     * @param field The backing field of the DropDelegate property
     * @param declaration The function that will contain this call
     * @return An IR call expression that calls drop() on the field
     */
    ...
    /**
     * Visits a simple function and implements its body if it's a generated drop function.
     *
     * This method identifies functions that were generated by the RAkIIDropGenerationExtension
     * and implements their bodies by generating code to call drop() on all DropDelegate properties
     * in reverse order of declaration.
     *
