...
internal class RAkIILoweringVisitor(
    ...
    override fun visitSimpleFunction(declaration: IrSimpleFunction) {
        ...
        if (origin !is IrDeclarationOrigin.GeneratedByPlugin || origin.pluginKey != RAkIIGenerationExtension.Key) return
        // If the function name doesn't match drop, we skip this function
        if (declaration.name != RAkIINames.dropFunctionName) return
